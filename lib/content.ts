...
export const SERVICES = [
  ...
  { icon: "/images/installation-case.png", title: "설치 사례", desc: "실제 구축현장 확인", href: "#service", tone: "navy" },
] as const;
...
export const FAQ: { q: string; intro?: string; items: string[] }[] = [
  {
