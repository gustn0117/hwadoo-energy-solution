...
export const COMPARE = {
  cpos: ["에버온", "플러그링크", "현대엔지니어링", "SK일렉링크"],
  pick: 0,
  rows: [
    { key: "운영사 설립연도", num: true, vals: ["2017년 1월", "2021년 1월", "2022년 1월", "2017년 1월"] },
    { key: "환경부 사업 운영기간", num: true, vals: ["9년", "4년", "3년", "9년"] },
    { key: "환경부 충전기 운영수량", num: true, vals: ["51,238기", "44,636기", "11,736기", "10,164기"] },
    { key: "제조사", num: false, vals: ["에버온 (자체생산)", "에바", "제니스코리아", "SK일렉링크 (OEM)"] },
    { key: "계약기간 / 무상 유지보수", num: false, vals: ["5년 · 7년 · 10년", "7년 · 10년", "7년 · 10년", "7년 · 10년"] },
    { key: "충전 기본요금", num: true, vals: ["296원/kWh", "324.4원/kWh", "292원/kWh", "295원/kWh"] },
    { key: "A/S 유지관리", num: false, vals: ["365일 24시간 · 점검주기 최소 연 6회", "365일 24시간 · 분기 1회", "365일 24시간 · 반기 1회", "365일 24시간 콜센터"] },
    { key: "손해보험 보상범위", num: false, vals: ["생산물배상책임보험 30억 (대인/대물 일괄)", "영업배상책임보험 50억 · 생산물 10억", "사고배상책임보험 대인 1.5억 · 대물 10억", "영업배상책임보험 100억"] },
    { key: "업계 특징", num: false, vals: [
